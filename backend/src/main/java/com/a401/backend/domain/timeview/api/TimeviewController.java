...
public class TimeviewController {
    ...
    public ResponseEntity<?> getDate(@PathVariable("date") String date,
        ...
        try {
            ...
            MinuteviewResponseDto response;
    ...
    public ResponseEntity<?> getMonth(@PathVariable("date") String date,
        ...
        try {
            MinuteviewResponseDto response = tvService.month(member, date);
            return new ResponseEntity<>(response, HttpStatus.OK);
        } catch (Exception e) {
            if (e.getMessage().equals("No value present")) {
                MinuteviewResponseDto response = new MinuteviewResponseDto();
    ...
    public ResponseEntity<?> getYear(@PathVariable("date") String date,
        ...
        try {
            MinuteviewResponseDto response = tvService.year(member, date);
            return new ResponseEntity<>(response, HttpStatus.OK);
        } catch (Exception e) {
            if (e.getMessage().equals("No value present")) {
                MinuteviewResponseDto response = new MinuteviewResponseDto();
    ...
    public ResponseEntity<?> getDays(@RequestParam(name = "startDate") String start,
        ...
        try {
            List<MinuteviewResponseDto> response = tvService.days(member, start, end);
            return new ResponseEntity<>(response, HttpStatus.OK);
        } catch (Exception e) {
            if (e.getMessage().equals("No value present")) {
                MinuteviewResponseDto response = new MinuteviewResponseDto();
